  ...
  return (
    <div className="">
      ...
      >
        ...
        <h1 className="text-center uppercase pt-24 text-[#3670AD]  text-5xl pb-6 tracking-wider font-['Permanent_Marker'] ">
          Baked With Love
          <img
            width={200}
            className="absolute ml-12 -rotate-12 left-96 top-2"
            src={coral}
            alt="cookie-image"
          />
          <img
            width={118}
            className="absolute -bottom-20 -rotate-12 right-80"
            src={love}
            alt="cookie-image"
          />
        </h1>
        ...
        <div className="w-full h-full">
          <div className="flex items-center justify-between px-16 pt-12">
            <div className="relative ">
              ...
              <p className="absolute w-[191px] -ml-3 text-lg font-medium tracking-wider top-32 left-72">Our ingredients are carefully sourced to ensure the best quality and flavour of our cookies. </p>
            </div>
            <div className="absolute mr-28 right-96 top-50">
              ...
              <p className="absolute w-[191px] text-lg font-medium tracking-wider -right-56 top-32">Our packaging is  designed with sustainability and preserving the freshness of our cookies in mind. </p>
            </div>
            <div className="absolute mt-24 ml-20 top-96 left-96">
              ...
              <p className="absolute w-[191px] text-lg font-medium tracking-wider -right-56 top-32">We are constantly improving our recipes to bring you the best quality bakes possible. </p>
            </div>
          </div>
        </div>
        </div>
